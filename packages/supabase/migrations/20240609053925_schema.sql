...
-- CREATE TABLE IF NOT EXISTS public.decrypted_bank_connections (
--   id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
--   access_token TEXT NULL,
--   created_at TIMESTAMP DEFAULT NOW(),
--   enrollment_id TEXT NULL,
...
--   logo_url TEXT NULL,
--   name TEXT NOT NULL,
--   decrypted_name TEXT NULL,
--   provider bank_providers NULL,
--   team_id UUID NOT NULL,
--   FOREIGN KEY (team_id) REFERENCES public.teams(id)
-- );

-- CREATE TABLE IF NOT EXISTS public.decrypted_bank_accounts (
...
CREATE TABLE IF NOT EXISTS public.bank_accounts (
  ...
  name TEXT NULL,
  team_id UUID NOT NULL,
  FOREIGN KEY (bank_connection_id) REFERENCES public.bank_connections(id),
...
CREATE TABLE IF NOT EXISTS public.transactions (
  ...
  -- FOREIGN KEY (bank_account_id) REFERENCES public.decrypted_bank_accounts(id),
...
-- CREATE TABLE IF NOT EXISTS public.decrypted_transactions (
--   id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
--   amount NUMERIC NOT NULL,
--   assigned_id UUID NULL,
--   balance NUMERIC NULL,
...
--   date TIMESTAMP DEFAULT NOW() NOT NULL,
--   description TEXT NULL,
--   decrypted_description TEXT NULL,
--   internal_id TEXT NOT NULL,
--   manual BOOLEAN NULL,
--   method transactionMethods NOT NULL,
--   name TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.transaction_attachments (
  ...
  -- FOREIGN KEY (transaction_id) REFERENCES public.decrypted_transactions(id)
);
...
CREATE TABLE IF NOT EXISTS public.inbox (
  ...
  FOREIGN KEY (attachment_id) REFERENCES public.transaction_attachments(id),
  FOREIGN KEY (team_id) REFERENCES public.teams(id),
  FOREIGN KEY (transaction_id) REFERENCES public.transactions(id),
  -- FOREIGN KEY (transaction_id) REFERENCES public.decrypted_transactions(id)
);
...
CREATE TABLE IF NOT EXISTS public.tracker_reports (
  ...
  team_id UUID NULL,
  FOREIGN KEY (created_by) REFERENCES public.users(id),
  FOREIGN KEY (project_id) REFERENCES public.tracker_projects(id),
  FOREIGN KEY (team_id) REFERENCES public.teams(id)
);
